...
public abstract class AppConfig {
	 ...
	 */
	protected abstract wd.android.util.util.MyLog.MyLogManager.Level initLogLevel();

	protected abstract wd.android.util.util.MyLog.MyLogManager.LogMode initLogMode();
}
