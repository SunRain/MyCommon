...
import wd.android.common.ui.view.LeftSliderLayout;
import wd.android.common.ui.view.LeftSliderLayout.OnLeftSliderLayoutStateListener;

public class LeftSliderMainActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.slidingdemo_left_main);
	...
	public void OnLeftSliderLayoutStateChanged(boolean bIsOpen) {
		if (bIsOpen) {
			Toast.makeText(this, "LeftSliderLayout is open!",
					Toast.LENGTH_SHORT).show();
		} else {
			Toast.makeText(this, "LeftSliderLayout is close!",
					Toast.LENGTH_SHORT).show();
		}
	...
	public void onClick(View v) {
		...
		case R.id.main_btn_below: {
			Toast.makeText(this, "btnBelow is clicked!", Toast.LENGTH_SHORT)
					.show();
			break;
		}
