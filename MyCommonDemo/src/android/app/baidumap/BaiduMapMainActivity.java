...
public class BaiduMapMainActivity extends BaseActivity {
    private static final MyMapManager myMapManager = new MyMapManager();
    ...
    public void onBeforeContentView(Bundle savedInstanceState) {
        ...
        myMapManager.initEngineManager(MainApp.getApp());
    }
        ...
        mMapListener = new MKMapViewListener() {
            ...
            public void onClickMapPoi(MapPoi mapPoiInfo) {
                ...
                if (mapPoiInfo != null) {
                    ...
                    Toast.makeText(MainApp.getApp(), title, Toast.LENGTH_SHORT)
                            .show();
            ...
            public void onMapLoadFinish() {
                Toast.makeText(MainApp.getApp(), "地图加载完成", Toast.LENGTH_SHORT)
                        .show();

            }
        };
        mMapView.regMapViewListener(MyMapManager.bMapManager, mMapListener);
    }
