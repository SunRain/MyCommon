...
import me.android.custom.am.ApplicationsState.AppEntry;
import me.android.custom.am.ApplicationsState.AppFilter;
import wd.android.common.ui.adapter.MyBaseAdapter;
...
public abstract class BaseAppAdapter extends
        MyBaseAdapter<ApplicationsState.AppEntry> implements Filterable,
    ...
    public void resume(int sort) {
        if (MyLog.isDebug())
            MyLog.d("Resume!  mResumed=" + mResumed);
        if (!mResumed) {
            mResumed = true;
            mSession.resume();
            mLastSortMode = sort;
